...
pub struct PlaybackState {
    pub is_playing: bool,
    pub current_time: f32,   // Current playback time in microseconds
    pub window_size: f32,    // Integration window in microseconds
    pub playback_speed: f32, // Speed multiplier (real-time factor)
    pub looping: bool,
